...
export const metadata: Metadata = {
  ...
  description:
    "Découvrez DressArt, votre marketplace pour créer des vêtements sur mesure. Choisissez parmi nos modèles exclusifs, sélectionnez vos tissus préférés et commandez votre création unique.",
  keywords: [...seoConfig.keywords, "accueil", "boutique en ligne", "vêtements haute couture"],
  openGraph: {
    title: "DressArt - Marketplace de Mode Sur Mesure",
    description:
      "Créez vos vêtements sur mesure avec DressArt. Des modèles exclusifs, des tissus premium, une création unique.",
