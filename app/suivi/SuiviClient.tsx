          ...
          {selectedOrder && !showAllOrders && (
            <div className="bg-white rounded-3xl p-8 border border-gray-200 mb-8">
              <div className="flex items-start justify-between mb-6">
                ...
                <span
                  className={`px-4 py-2 rounded-full border font-semibold ${getStatusColor(selectedOrder.status)}`}
                >
              ...
              {ordersData.map((order) => (
                ...
                >
                  <div className="flex items-start justify-between mb-4">
                    ...
                    <span
                      className={`px-3 py-1 rounded-full border text-sm font-semibold ${getStatusColor(order.status)}`}
                    >
                      {order.status}
                    </span>
                  </div>
          ...
          {!selectedOrder && !showAllOrders && (
            <div className="bg-blue-50 border border-blue-200 rounded-xl p-6">
              ...
              <ul className="text-sm text-blue-800 space-y-2">
                ...
                <li>
                  • Cliquez sur &quot;Voir toutes mes commandes&quot; pour consulter votre
                  historique complet
                </li>
              </ul>
              ...
              <div className="mt-4 pt-4 border-t border-blue-200">
                <p className="font-semibold text-blue-900 mb-2">
                  Pour tester, essayez ces numéros :
                </p>
