...
export default function MesureClient({ id, tissuId }: MesureClientProps) {
  ...
  const isPhoneValid = useMemo(
    () => /^\+22901\d{8}$/.test(phoneClean) || /^\d{10}$/.test(phoneClean),
    [phoneClean]
  );
  ...
  const handlePaymentConfirm = async () => {
    ...
    try {
      ...
      const baseAmount = isOwnFabric
        ? model.prix_base
        : tissu
          ? tissu.prix_metre + model.prix_base
          : model.prix_base;
            ...
            {isOwnFabric ? (
              <div className="py-12 px-6 text-center bg-gray-50 rounded-2xl border-2 border-dashed border-gray-300">
                ...
                <p className="text-gray-600">
                  Vous avez choisi d&apos;utiliser votre propre tissu. N&apos;oubliez pas de
                  l&apos;apporter lors de votre rendez-vous ou de votre passage en atelier.
                </p>
              </div>
            ) : tissu ? (
              <>
                ...
                <div className="space-y-1 text-sm">
                  <p>
                    <span className="font-semibold">Qualité:</span> {tissu.texture}
                  </p>
                  <p>
                    <span className="font-semibold">Couleur:</span> {tissu.couleur}
                  </p>
                  <p className="text-lg font-bold text-gray-900 mt-2">
                    {tissu.prix_metre.toLocaleString("fr-FR")} FCFA
                  </p>
                </div>
              </>
            ) : null}
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-blue-800">
                      <strong>Cotonou :</strong> Récupération du tissu ou prise de RDV gratuite
                      <br />
        ...
        <div className="fixed inset-0 bg-black/60 bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-3xl p-8 max-w-lg w-full shadow-2xl max-h-[90vh] overflow-y-auto">
                ...
                <div>
                  ...
                  {userName && !isNameValid && (
                    <div className="mt-1 text-sm text-red-600">
                      Entrez votre nom complet (prénom + nom).
                    </div>
                  )}
                </div>
                <div>
                  ...
                  {userPhone && !isPhoneValid && (
                    <div className="mt-1 text-sm text-red-600">
                      Format : 10 chiffres (ex: 0164000001) ou +229 01 suivi de 8 chiffres (ex:
                      +2290164000001).
                    </div>
                  )}
                </div>
            ...
            <div className="mb-6 pb-6 border-b border-gray-200">
              ...
              <div className="space-y-3">
                <label
                  className="flex items-start gap-3 cursor-pointer p-3 border-2 rounded-xl transition-all hover:border-gray-400"
                  style={{
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-gray-600 mt-1">
                      ...
                      {Math.round(
                        (isOwnFabric
                          ? model.prix_base
                          : (tissu ? tissu.prix_metre + model.prix_base : model.prix_base) +
                            deliveryFee) * 0.3
            ...
            <div className="mb-6">
              ...
              <div className="space-y-3">
                ...
                <div className="flex justify-between items-center text-sm">
                  ...
                  <span className="font-semibold">
                    {model.prix_base.toLocaleString("fr-FR")} FCFA
                  </span>
                </div>
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-xl p-4 mb-6">
              <p className="text-sm text-blue-800">
                💡 <strong>Note :</strong> Le paiement sera traité via Mobile Money. Vous recevrez
                les instructions par SMS au {userPhone || "numéro indiqué"}.
              </p>
            </div>
            ...
            <div className="flex gap-3">
              ...
              <button
                ...
                className={`flex-1 px-6 py-3 rounded-full font-semibold transition-all cursor-pointer flex items-center justify-center gap-2 ${
                  isNameValid && userPhone && isPhoneValid && !isProcessing
                    ? "bg-gray-900 text-white hover:bg-gray-800"
                    : "bg-gray-300 text-gray-500 cursor-not-allowed"
                }`}
              >
