...
const Avatar = ({ color, initial }: { color: string; initial: string }) => (
  <div
    className={`w-10 h-10 rounded-full border-2 border-white flex items-center justify-center text-xs font-bold text-white ${color} -ml-4 first:ml-0`}
  >
    {initial}
  </div>
);
      ...
      <div className="container mx-auto px-4 h-full relative flex flex-col justify-center items-center">
        ...
        <div className="absolute left-4 bottom-40 md:left-10 md:bottom-80 max-w-md z-20 hidden lg:block">
          <p className="text-gray-600 text-lg font-medium leading-relaxed">
            Découvrez notre collection de vêtements sur mesure. Choisissez votre modèle,
            sélectionnez votre tissu, et laissez-nous créer la pièce parfaite pour vous.
          </p>
        </div>
